...
const lengthBodyMessage = socialMediaComments.map(comment => ({ ...comment, isInvalid: comment.body.length > 180 }));
...
const arrayEmailMap = socialMediaComments.map(comment => ({ [comment.id]: comment.email }));
